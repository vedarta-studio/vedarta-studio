    ...
    <section id="contact" className="py-24 bg-[#041a16] relative">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          <div>
            <h2 className="text-5xl font-bold mb-8 italic font-serif text-[#f5f5dc]">
              Начнем работу <br /> над вашим проектом?
            </h2>
            ...
            <div className="space-y-8">
              ...
              <div
                ...
                onClick={() => window.open(siteConfig.contacts.telegramLink)}
              >
                ...
                <div>
                  <p className="text-xs text-[#0088cc] uppercase tracking-widest font-black">
                    Telegram
                  </p>
              ...
              <div
                className="flex items-center gap-6 group cursor-pointer"
                onClick={() => window.open(siteConfig.contacts.phoneLink)}
              >
                <div className="w-14 h-14 rounded-full bg-[#d4af37]/10 flex items-center justify-center border border-[#d4af37]/30">
                  <svg className="w-6 h-6 text-[#fcf6ba]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  <p className="text-xs text-[#f5f5dc]/40 uppercase tracking-widest font-black">
                    Телефон
                  </p>
                  <p className="text-2xl font-black text-[#f5f5dc]">
              ...
              <div className="pt-8 border-t border-white/10">
                <div className="flex flex-wrap gap-x-8 gap-y-4">
                  {siteConfig.contacts.socialLinks.map((social) => (
                    <button
                      key={social.id}
                      onClick={() => setShowSocialManifesto(true)}
                      className="text-sm font-bold tracking-widest text-[#d4af37]/60 hover:text-white transition-all uppercase"
                    >
                      {social.name}
                    </button>
                  ))}
      ...
      {showSocialManifesto && (
        <div className="fixed inset-0 z-[1000] bg-[#041a16]/95 backdrop-blur-2xl overflow-y-auto animate-fade-in">
          ...
          <div className="min-h-screen flex items-start justify-center p-4 md:items-center md:p-6">
            ...
            <div className="relative group max-w-4xl w-full bg-white/[0.02] border border-white/5 p-6 md:p-12 rounded-sm shadow-2xl">

              <div className="text-[#f5f5dc]/80 text-base md:text-lg leading-relaxed italic font-serif space-y-2 pt-4 md:pt-12">

                {/* текст для телефона */}
                <div className="md:hidden">
                  <p>Время — единственный невосполнимый ресурс.</p>
                  <p>Лучше подарите эти минуты себе:</p>
                  <p>тишине, прогулке, разговору, дыханию, чашечке чая у окна,</p>
                  <p>интересной книге в кресле под мягким и уютным пледом,</p>
                  <p>этому уникальному моменту.</p>
                  <p>Счастье — это безграничная свобода выбора действий!</p>
                  <p>И вы всегда можете выбрать Жить Настоящую Жизнь!</p>
                </div>

                {/* полный текст для компьютера */}
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 border-t border-white/5 mt-8 pt-8">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <h4 className="text-2xl font-logo italic text-[#d4af37]">
                      {siteConfig.founder.name}
                    </h4>

                    <p className="text-[8px] text-[#d4af37]/40 tracking-widest uppercase font-black">
                      Founder of VedArta
                    </p>
                  </div>
                </div>
                ...
                <button
                  onClick={() => setShowSocialManifesto(false)}
                  className="text-[9px] font-black uppercase text-[#d4af37] border-b border-[#d4af37]/10 pb-1"
                >
                  Вернуться
                </button>
