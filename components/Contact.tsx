    ...
    <section id="contact" className="py-24 bg-[#041a16] relative">
      ...
      {showSocialManifesto && (
        <div className="fixed inset-0 z-[1000] bg-[#041a16]/95 backdrop-blur-2xl overflow-y-auto animate-fade-in">
          <div className="min-h-screen flex items-start md:items-center justify-center p-4 md:p-6 py-10">

            <div className="relative group max-w-4xl w-full bg-white/[0.02] border border-white/5 p-6 md:p-12 rounded-sm shadow-2xl max-h-[calc(100vh-4rem)] overflow-y-auto">
