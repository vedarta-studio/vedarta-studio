...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#0e2a1f] py-24 border-t border-[#fff7a0]/10">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-16">
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-[10px] text-[#fff7a0]/50 tracking-widest font-bold uppercase whitespace-normal break-words">
      ...
      {showSocialManifesto && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-[#0e2a1f]/95 backdrop-blur-2xl p-6 animate-fade-in overflow-y-auto">
