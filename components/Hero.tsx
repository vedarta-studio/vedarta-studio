...
export const Hero: React.FC<HeroProps> = ({ onOpenAI }) => {
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col overflow-hidden bg-[#0e2a1f]">
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[#0e2a1f]/70 via-transparent to-[#0e2a1f]/80"></div>
      </div>
        ...
        <div className="w-full flex justify-end items-end mt-auto">
          <div className="max-w-xl text-left lg:text-right flex flex-col items-start lg:items-end animate-fade-in delay-400">
            <div className="lg:border-r-2 border-l-2 lg:border-l-0 border-[#ffcc00]/40 lg:pr-10 lg:pl-0 pl-6 py-2">
              <p className="block w-full text-xl md:text-2xl font-serif font-bold italic text-white mb-4 tracking-wide uppercase drop-shadow-md whitespace-normal break-words">
              ...
              <div className="flex flex-col sm:flex-row gap-4 md:gap-6 w-full lg:justify-end">
                ...
                <button onClick={onOpenAI} className="px-10 py-5 rounded-sm border-2 border-[#ffcc00]/40 bg-[#0e2a1f]/60 backdrop-blur-md text-[10px] font-black tracking-[0.4em] uppercase text-[#ffcc00]">
                  AI Ассистент
                </button>
              </div>
            </div>
