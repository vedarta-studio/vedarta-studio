...
export const Pricing: React.FC = () => {
  ...
  return (
    <section id="pricing" className="py-32 bg-[#0e2a1f] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 max-w-7xl mx-auto">
          {siteConfig.pricing.map((plan, idx) => (
            ...
            >
              {plan.highlight && (
                <div className="absolute -top-5 left-1/2 -translate-x-1/2 bg-[#d4af37] text-[#0e2a1f] text-[9px] font-black uppercase tracking-[0.3em] px-6 py-2 rounded-full">
              ...
              <button 
                ...
                className={`w-full py-5 text-[10px] font-black uppercase tracking-[0.3em] transition-all border ${plan.highlight ? 'btn-gold' : 'border-[#d4af37]/40 text-[#d4af37] hover:bg-[#d4af37] hover:text-[#0e2a1f]'}`}
              >
                Обсудить проект
              </button>
            </div>
